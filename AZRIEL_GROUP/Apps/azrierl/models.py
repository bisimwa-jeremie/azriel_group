...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    user_image = models.ImageField(upload_to="img_user/", blank=True, null=True)
...
class ActivityCategory(models.Model):
    ...
    activ_img =  models.ImageField(upload_to="activ_imgs/", blank=True, null=True)
...
class Activity(models.Model):
    ...
    image_activity= models.ImageField(upload_to="images/", blank=True, null=True)
...
class Company(models.Model):
    ...
    camp_image = models.ImageField(upload_to="camp_img/", blank=True, null=True)
